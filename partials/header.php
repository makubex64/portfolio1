...
<link rel="icon" type="image/png" sizes="16x16" href="./img/favicon-16x16.png">
  ...
  <body>
  	<!-- navbar o barra de navegacion- de la cabecera -->
<!-- navbar o barra de navegacion- de la cabecera -->
  ...
  <div class="lalala collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link text-dark" href="./index.php"><strong>Home</strong></a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-dark" href="./about.php"><strong>About</strong></a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-dark" href="./contact.php"><strong>Contact</strong></a>
      </li>
      <!-- <li class="nav-item">
